                    ...
                    <div class="float-right">
                        <div class="collapse navbar-collapse ">
                            <ul class="navbar-nav mb-2 mb-lg-0">
                                <li class="nav-item ">
                                    <a class="nav-link my-auto mr-4" style="font-size: 24px;" href="@if(Auth::check()) {{ route('logout') }} @else /login @endif"><i
                                            class="bi @if(Auth::check()) bi-box-arrow-right @else bi-person @endif "></i></a>
                                </li>
        ...
        <div class="offcanvas-body">
            <div id="sidebar">
                <div class="nav flex-column py-3 ">
                    <a href="#menu1" class="nav-link text-dark collapsed" style="font-size: 18px"
                        data-bs-toggle="collapse" role="button"><i class="bi bi-person"></i> Profile</a>
                        ...
                        <b>
                            <div class="dropdown ">
                                <a class=" dropdown-toggle link-dark" style="text-decoration: none;" href="#"
                                    id="runningShoesDropdown" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    Sepatu Lari
                                </a>
